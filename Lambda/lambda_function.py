...
def validate_data(first_name, age, investment_amount,risk_level, source):
    ...
    # Validate that the user is above zero and below 65
    if age is not None:
      if age < "0" or age > "65":
        return build_validation_result(
            False,
            "age",
            "You should be between 0 to 65 years to utilize this service, "
    ...
    if investment_amount is not None:
      if investment_amount < 5000:
        return build_validation_result(
            False,
            "Investment amount",
            "You should have more than 5000 in investement to utilize this service"
            "please provide amount more or equal to 5000",
        )

      if risk_level is not None:
        if risk_level != "low" or risk_level !="none" or  risk_level !="high" or risk_level !="medium":
            return build_validation_result(
                False,
                "riskLevel",
                "You should provide an investment level"
                "please provide your risl level",
        )
...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
        ...
        validation_result = validate_data(first_name, age, investment_amount,risk_level, source)
